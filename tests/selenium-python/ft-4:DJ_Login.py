...
class Ft1DJLogin(unittest.TestCase):
    def setUp(self):
    ...
    def test_ft4_dj_login(self):
        driver = self.driver
        driver.get(self.base_url + "/login")
        driver.find_element_by_id("username").clear()
        driver.find_element_by_id("username").send_keys("DJlogin")
        ...
        self.assertEqual(current_user.text, 'DJlogin')
        ...
        self.assertEqual(username_value, 'DJlogin')
        self.assertEqual(firstname_value, 'DJ_name')
        self.assertEqual(lastname_value, 'DJ_lastname')
        self.assertEqual(email_value, 'djmail@email.com')
        self.assertEqual(phone_value, '1234567890')

        #check for top menu now playing, calendar, add media, library, help, calendar
        ...
        m5=driver.find_element_by_xpath("/html/body/div[1]/ul/li[5]/a/span")
        self.assertEqual(m1.text, 'HISTORY')
        m6=driver.find_element_by_xpath("/html/body/div[1]/ul/li[6]/a/span")
