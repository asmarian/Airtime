...
class Ft1PMLogin(unittest.TestCase):
    def setUp(self):
    ...
    def test_ft5_pm_login(self):
        ...
        self.assertEqual(username_value, 'progman')
        self.assertEqual(firstname_value, 'progman_name')
        self.assertEqual(lastname_value, 'progman_lastname')
        self.assertEqual(email_value, 'progman@email.com')
